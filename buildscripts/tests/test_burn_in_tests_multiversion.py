...
NUM_REPL_MIXED_VERSION_CONFIGS = len(evg_expansions.REPL_MIXED_VERSION_CONFIGS)
NUM_SHARDED_MIXED_VERSION_CONFIGS = len(evg_expansions.SHARDED_MIXED_VERSION_CONFIGS)
