...
class MongodLauncher(object):
    ...
    def launch_mongod_program(  # pylint: disable=too-many-branches,too-many-statements,too-many-arguments
        ...
        if "logComponentVerbosity" not in suite_set_parameters:
            suite_set_parameters["logComponentVerbosity"] = self.get_default_log_component_verbosity_for_mongod()
        ...
        if ("replSet" in mongod_options and "shutdownTimeoutMillisForSignaledShutdown" not in suite_set_parameters):
